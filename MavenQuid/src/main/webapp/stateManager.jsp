...
<div id="wrapper">
	<table>
		...
		<form action="stateManager.jsp" target="_SELF" method="GET" >
		<tr>
			<td colspan="4"></td>
			<td><input type="text" name="state_search"></td>
			<td><input type="submit" value="검색"  class="submit-btn" onclick="alert('test');"></td>
